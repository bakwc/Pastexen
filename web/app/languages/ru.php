<?php
	...
	$this->languageStrings = array(
		...
		'error_login_bad'					=> 'Выбран некорректный логин. Убедитесь, что Ваш логин содержит от 4 до 25 букв латинского алфавита и цифр.',
		...
		'error_filename_bad'				=> 'Неправильное имя файла. Убедитесь, что оно содержит от 5 до 25 символов.',
		'error_extension_bad'				=> 'Неправильное расширение файла. Убедитесь, что оно содержит от 1 до 10 символов.',
